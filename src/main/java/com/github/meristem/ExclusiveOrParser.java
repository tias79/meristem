 ...
 * expecting only one of them to return a non-nil parse result. Evaluation is
 * lazy.
 *
 * @see NilParseResult
 */
public class ExclusiveOrParser extends AbstractCompositeParser {

	public ExclusiveOrParser(Parser... parsers) {
		super(parsers);
	}
